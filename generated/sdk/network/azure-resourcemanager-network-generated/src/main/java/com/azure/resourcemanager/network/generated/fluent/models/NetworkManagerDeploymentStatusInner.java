...
public final class NetworkManagerDeploymentStatusInner {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(NetworkManagerDeploymentStatusInner.class);
     ...
     * @return the NetworkManagerDeploymentStatusInner object itself.
     */
    public NetworkManagerDeploymentStatusInner withCommitTime(OffsetDateTime commitTime) {
     ...
     * @return the NetworkManagerDeploymentStatusInner object itself.
     */
    public NetworkManagerDeploymentStatusInner withRegion(String region) {
        this.region = region;
        return this;
    }
     ...
     * @return the NetworkManagerDeploymentStatusInner object itself.
     */
    public NetworkManagerDeploymentStatusInner withDeploymentStatus(DeploymentStatus deploymentStatus) {
     ...
     * @return the NetworkManagerDeploymentStatusInner object itself.
     */
    public NetworkManagerDeploymentStatusInner withConfigurationIds(List<String> configurationIds) {
     ...
     * @return the NetworkManagerDeploymentStatusInner object itself.
     */
    public NetworkManagerDeploymentStatusInner withDeploymentType(DeploymentType deploymentType) {
     ...
     * @return the NetworkManagerDeploymentStatusInner object itself.
     */
    public NetworkManagerDeploymentStatusInner withErrorMessage(String errorMessage) {
