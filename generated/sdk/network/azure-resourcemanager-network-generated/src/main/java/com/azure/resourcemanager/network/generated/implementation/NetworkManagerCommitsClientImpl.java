...
public final class NetworkManagerCommitsClientImpl implements NetworkManagerCommitsClient {
    private final ClientLogger logger = new ClientLogger(NetworkManagerCommitsClientImpl.class);
    ...
    private interface NetworkManagerCommitsService {
        ...
        Mono<Response<Void>> post(
            ...
            @BodyParam("application/json") NetworkManagerCommit parameters,
    ...
    private Mono<Response<Void>> postWithResponseAsync(
        String resourceGroupName, String networkManagerName, NetworkManagerCommit parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> postAsync(String resourceGroupName, String networkManagerName, NetworkManagerCommit parameters) {
        return postWithResponseAsync(resourceGroupName, networkManagerName, parameters)
    ...
    public void post(String resourceGroupName, String networkManagerName, NetworkManagerCommit parameters) {
        postAsync(resourceGroupName, networkManagerName, parameters).block();
    }
    ...
    public Response<Void> postWithResponse(
        String resourceGroupName, String networkManagerName, NetworkManagerCommit parameters, Context context) {
        return postWithResponseAsync(resourceGroupName, networkManagerName, parameters, context).block();
    }
}
