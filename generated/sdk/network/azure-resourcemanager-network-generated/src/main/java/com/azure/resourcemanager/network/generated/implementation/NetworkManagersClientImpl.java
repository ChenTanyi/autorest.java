...
public final class NetworkManagersClientImpl implements NetworkManagersClient {
    private final ClientLogger logger = new ClientLogger(NetworkManagersClientImpl.class);
    ...
    private interface NetworkManagersService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkManagerInner>> patchTags(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkManagerName") String networkManagerName,
    ...
    private Mono<NetworkManagerInner> getByResourceGroupAsync(String resourceGroupName, String networkManagerName) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, networkManagerName)
            .flatMap(
                (Response<NetworkManagerInner> res) -> {
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String networkManagerName) {
        return deleteWithResponseAsync(resourceGroupName, networkManagerName)
    ...
    public void delete(String resourceGroupName, String networkManagerName) {
        deleteAsync(resourceGroupName, networkManagerName).block();
    }
    ...
    public Response<Void> deleteWithResponse(String resourceGroupName, String networkManagerName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, networkManagerName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NetworkManagerInner>> patchTagsWithResponseAsync(
        String resourceGroupName, String networkManagerName, TagsObject parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NetworkManagerInner> patchTagsAsync(
        String resourceGroupName, String networkManagerName, TagsObject parameters) {
        return patchTagsWithResponseAsync(resourceGroupName, networkManagerName, parameters)
            .flatMap(
                (Response<NetworkManagerInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NetworkManagerInner patchTags(String resourceGroupName, String networkManagerName, TagsObject parameters) {
        return patchTagsAsync(resourceGroupName, networkManagerName, parameters).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkManagerInner> patchTagsWithResponse(
        String resourceGroupName, String networkManagerName, TagsObject parameters, Context context) {
        return patchTagsWithResponseAsync(resourceGroupName, networkManagerName, parameters, context).block();
    }
