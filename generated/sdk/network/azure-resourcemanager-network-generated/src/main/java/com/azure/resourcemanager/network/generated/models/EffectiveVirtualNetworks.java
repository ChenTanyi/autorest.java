...
/** Resource collection API of EffectiveVirtualNetworks. */
public interface EffectiveVirtualNetworks {
    /**
     ...
     */
    PagedIterable<EffectiveVirtualNetwork> listByNetworkManager(String resourceGroupName, String networkManagerName);
     ...
     * @return result of the request to list Effective Virtual Network.
     */
    PagedIterable<EffectiveVirtualNetwork> listByNetworkManager(
     ...
     * @return result of the request to list Effective Virtual Network.
     */
    PagedIterable<EffectiveVirtualNetwork> listByNetworkGroup(
