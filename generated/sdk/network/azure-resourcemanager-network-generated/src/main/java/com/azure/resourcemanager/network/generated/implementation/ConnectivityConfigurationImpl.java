...
public final class ConnectivityConfigurationImpl
    ...
    public ConnectivityConfigurationImpl withDisplayName(String displayName) {
    ...
    public ConnectivityConfigurationImpl withHubId(String hubId) {
        this.innerModel().withHubId(hubId);
        return this;
    }

    public ConnectivityConfigurationImpl withIsGlobal(Boolean isGlobal) {
    ...
    public ConnectivityConfigurationImpl withDeleteExistingPeering(Boolean deleteExistingPeering) {
