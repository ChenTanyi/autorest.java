...
public final class NetworkGroupImpl implements NetworkGroup, NetworkGroup.Definition, NetworkGroup.Update {
    ...
    public List<GroupMembersItem> groupMembers() {
        List<GroupMembersItem> inner = this.innerModel().groupMembers();
        if (inner != null) {
    ...
    public String conditionalMembership() {
        return this.innerModel().conditionalMembership();
    }
    ...
    public NetworkGroupImpl withDisplayName(String displayName) {
    ...
    public NetworkGroupImpl withMemberType(MemberType memberType) {
        this.innerModel().withMemberType(memberType);
        return this;
    }

    public NetworkGroupImpl withGroupMembers(List<GroupMembersItem> groupMembers) {
        this.innerModel().withGroupMembers(groupMembers);
        return this;
    }

    public NetworkGroupImpl withConditionalMembership(String conditionalMembership) {
        this.innerModel().withConditionalMembership(conditionalMembership);
        return this;
    }
