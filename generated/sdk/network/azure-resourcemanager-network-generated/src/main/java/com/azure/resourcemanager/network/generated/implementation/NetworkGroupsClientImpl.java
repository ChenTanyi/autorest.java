...
public final class NetworkGroupsClientImpl implements NetworkGroupsClient {
    private final ClientLogger logger = new ClientLogger(NetworkGroupsClientImpl.class);
    ...
    private Mono<NetworkGroupInner> getAsync(
        ...
        return getWithResponseAsync(resourceGroupName, networkManagerName, networkGroupName)
            .flatMap(
                (Response<NetworkGroupInner> res) -> {
    ...
    private Mono<NetworkGroupInner> createOrUpdateAsync(
        ...
        return createOrUpdateWithResponseAsync(
            ...
            .flatMap(
                (NetworkGroupsCreateOrUpdateResponse res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NetworkGroupInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String networkManagerName,
        String networkGroupName,
        NetworkGroupInner parameters,
    ...
    private Mono<Void> deleteAsync(String resourceGroupName, String networkManagerName, String networkGroupName) {
        return deleteWithResponseAsync(resourceGroupName, networkManagerName, networkGroupName)
    ...
    public void delete(String resourceGroupName, String networkManagerName, String networkGroupName) {
        deleteAsync(resourceGroupName, networkManagerName, networkGroupName).block();
    }
    ...
    public Response<Void> deleteWithResponse(
        String resourceGroupName, String networkManagerName, String networkGroupName, Context context) {
        return deleteWithResponseAsync(resourceGroupName, networkManagerName, networkGroupName, context).block();
    }
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return result of the request to list NetworkGroup.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
