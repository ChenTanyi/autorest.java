...
public final class PolicyExemptionsImpl implements PolicyExemptions {
    ...
    public PolicyExemptionsImpl(PolicyExemptionsClient innerClient, PolicyManager serviceManager) {
    ...
    public PagedIterable<PolicyExemption> list() {
        ...
        return inner.mapPage(inner1 -> new PolicyExemptionImpl(inner1, this.manager()));
    }
