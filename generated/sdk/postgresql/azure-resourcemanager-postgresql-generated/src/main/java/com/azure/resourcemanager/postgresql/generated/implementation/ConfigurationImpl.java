...
public final class ConfigurationImpl implements Configuration, Configuration.Definition, Configuration.Update {
    ...
    public ConfigurationImpl(String name, PostgreSqlManager serviceManager) {
    ...
    public ConfigurationImpl(ConfigurationInner innerObject, PostgreSqlManager serviceManager) {
