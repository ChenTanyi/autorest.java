...
public final class GenerateDetailedCostReportOperationStatusClientImpl
    ...
    private final ClientLogger logger = new ClientLogger(GenerateDetailedCostReportOperationStatusClientImpl.class);
    ...
    private interface GenerateDetailedCostReportOperationStatusService {
    ...
    private Mono<GenerateDetailedCostReportOperationStatusesInner> getAsync(String operationId, String scope) {
        return getWithResponseAsync(operationId, scope)
            .flatMap(
                (Response<GenerateDetailedCostReportOperationStatusesInner> res) -> {
