        ...
        this.innerObject =
            serviceManager
                ...
                .createOrUpdateOwnershipIdentifierWithResponse(
                    resourceGroupName, domainName, name, innerObject, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public DomainOwnershipIdentifier create(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getDomains()
                .createOrUpdateOwnershipIdentifierWithResponse(
                    resourceGroupName, domainName, name, innerObject, context)
                .getValue();
        return this;
    }
    ...
    public DomainOwnershipIdentifier apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDomains()
                .updateOwnershipIdentifierWithResponse(resourceGroupName, domainName, name, innerObject, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public DomainOwnershipIdentifier apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getDomains()
                .updateOwnershipIdentifierWithResponse(resourceGroupName, domainName, name, innerObject, context)
                .getValue();
        return this;
    }
